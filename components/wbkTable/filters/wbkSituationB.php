<!-- Situation Select -->
<select class="selectpicker show-tick" data-live-search="true" id="wbkSituationB" title="Situation B" show-tick>
...
<button class="btn" id="wbkSitBClear"><i class="fas fa-times-circle"></i></button>