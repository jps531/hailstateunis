...
//-----------
// Initialize Table
export var taylorsvilleTable = $('#taylorsvilleTable').DataTable( {
...
$(document).ready(function(){
    $("#ttSearch").on("keyup", function() {
      taylorsvilleTable.search(this.value).draw();
    });
  });

$(function() {
  $('#ttSearchClear').click(function() {
    $("#ttSearch").val('').trigger('keyup');
  });
});
//-----------
...
// Clear All Filters
$(document).ready(function(){
  $('#ttClearFilters').click(function() {
    $('#ttSearchClear').click();
    $('#ttOpponentClear').click();
    $('#ttSeasonClear').click();
    $('#ttGameCClear').click();
    $('#ttGameBClear').click();
    $('#ttGameAClear').click();
    $('#ttUniformCClear').click();
    $('#ttUniformBClear').click();
    $('#ttUniformAClear').click();
  });
});
//-----------