...
$(document).ready(function(){
  $("#mbkUniformA").on("change", function() {
    ...
    // Uniform Designs
    mbkuOptSelectedA = sit.searchTable(group,tbl.mbkTable,searchTerm,mbkuOptSelectedA,1,4);
  });
});
//-----------
...
$(document).ready(function(){
  $("#mbkUniformB").on("change", function() {
    ...
    // Uniform Designs
    mbkuOptSelectedB = sit.searchTable(group,tbl.mbkTable,searchTerm,mbkuOptSelectedB,1,4);
  });
});
//-----------
