...
//-----------
// Initialize Table
export var raleighTable = $('#raleighTable').DataTable( {
                  ...
                  details: {
                    renderer: function ( api, rowIdx, columns ) {
                        ...
                        if (columns[9].hidden){
                          ...
                          data += '<tr><td><span class="badge" style="background-color: #390613; color: white;">Raleigh</span></td><td>' + 
...
$(document).ready(function(){
    $("#rhsSearch").on("keyup", function() {
      raleighTable.search(this.value).draw();
    });
  });

$(function() {
  $('#rhsSearchClear').click(function() {
    $("#rhsSearch").val('').trigger('keyup');
  });
});
//-----------
...
// Clear All Filters
$(document).ready(function(){
  $('#rhsClearFilters').click(function() {
    $('#rhsSearchClear').click();
    $('#rhsOpponentClear').click();
    $('#rhsSeasonClear').click();
    $('#rhsGameCClear').click();
    $('#rhsGameBClear').click();
    $('#rhsGameAClear').click();
    $('#rhsUniformCClear').click();
    $('#rhsUniformBClear').click();
    $('#rhsUniformAClear').click();
  });
});
//-----------
