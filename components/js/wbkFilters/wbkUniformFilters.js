...
$(document).ready(function(){
  $("#wbkUniformA").on("change", function() {
    ...
    // Uniform Designs
    wbkuOptSelectedA = sit.searchTable(group,tbl.wbkTable,searchTerm,wbkuOptSelectedA,1,4);
  });
});
//-----------
...
$(document).ready(function(){
  $("#wbkUniformB").on("change", function() {
    ...
    // Uniform Designs
    wbkuOptSelectedB = sit.searchTable(group,tbl.wbkTable,searchTerm,wbkuOptSelectedB,1,4);
  });
});
//-----------
