<!-- Season Select -->
<select class="selectpicker" data-live-search="true" title="Season(s)" id="ttSelectYear" multiple>
...
<button class="btn clear" id="ttSeasonClear"><i class="fas fa-times-circle"></i></button>