<!-- Uniform Select -->
<select class="selectpicker" data-live-search="true" id="rhsUniformC" title="Uniform C">
...
<button class="btn clear" id="rhsUniformCClear"><i class="fas fa-times-circle"></i></button>
