<!-- Season Select -->
<select class="selectpicker" data-live-search="true" title="Season(s)" id="rhsSelectYear" multiple>
...
<button class="btn clear" id="rhsSeasonClear"><i class="fas fa-times-circle"></i></button>
