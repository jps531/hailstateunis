<!-- Situation Select -->
<select class="selectpicker show-tick" data-live-search="true" id="mbkSituationB" title="Situation B" show-tick>
  ...
  <optgroup label="Head Coaches">
    <option>Ben Howland</option>
    <option>Rick Ray</option>
    <option>Rick Stansbury</option>
    <option>Richard Williams</option>
...
<button class="btn clear" id="mbkSitBClear"><i class="fas fa-times-circle"></i></button>