...
('Coppin State', 'MEAC', '#0a3154', '#ffc60d'),
...
('Iowa State', 'Big XII', '#961530', '#ffc500'),
...
('Michigan State', 'Big 10', '#1b5346', 'white'),
...
('Ohio State', 'Big 10', 'b2b8be', '#d0073b'),
